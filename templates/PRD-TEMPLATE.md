...
- 🔗 [Supabase 数据库操作](https://github.com/ZT142815/openclaw-config/blob/main/workspace-developer/skills/SUPABASE.md)
- 🔗 [测试方案](https://github.com/ZT142815/openclaw-config/blob/main/workspace-tester/skills/TEST-PLAN-TEMPLATE.md)
- 🔗 [API设计最佳实践](https://restfulapi.net/)

> ⚠️ **2026-03-29 更新**：引用路径已修正为 GitHub 仓库路径
> 本地路径：~/.openclaw/workspace-developer/skills/SUPABASE.md
> 本地路径：~/.openclaw/workspace-tester/skills/TEST-PLAN-TEMPLATE.md
